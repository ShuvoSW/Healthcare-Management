...
const getStatusCodeFromPrismaError = (errorCode: string): number => {
    ...
    //P2002: Unique constraint failed
     ...
     // P6003 : Prisma Accelararate plan limit exceeded = 402 Payment Require
     if(errorCode === "P6003") {
     ...
     // P2XXX : except unhandled errors, Bad Requests
...
export  const handlePrismaClientUnknownRequestError = (error: Prisma.PrismaClientUnknownRequestError) : TErrorResponse => {
    let cleanMessage  = error.message;
